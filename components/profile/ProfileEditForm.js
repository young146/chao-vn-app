  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>
            {t("phone")} <Text style={styles.required}>{t("required")}</Text>
          </Text>
          <TextInput
            style={styles.input}
            value={phone}
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>
            {t("city")} <Text style={styles.required}>{t("required")}</Text>
          </Text>
          <View style={styles.pickerWrapper}>
            <Picker
            ...
            >
              ...
              {CITIES.map((city) => (
                <Picker.Item
                  key={city}
                  label={translateCity(city, i18n.language)}
                  value={city}
                />
              ))}
            </Picker>
            ...
            <View style={styles.pickerWrapper}>
              ...
              >
                ...
                {apartments.map((apt) => (
                  <Picker.Item
                    key={apt}
                    label={translateOther(apt, i18n.language)}
                    value={apt}
                  />
                ))}
              </Picker>
