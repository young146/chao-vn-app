(function ($) {
    $(document).ready(function () {
        console.log("🔥 [DEBUG] Firebase Auth JS가 브라우저에 성공적으로 로드되었습니다!");
        ...
        $kakaoLoginBtn.on('click', function (e) {
            e.preventDefault();
            console.log("🔥 [DEBUG] 카카오 버튼이 클릭되었습니다.");
            
            if (typeof Kakao === 'undefined') {
                alert("카카오 SDK가 서버에서 아직 로드되지 않았습니다.");
        ...
        $appleLoginBtn.on('click', function (e) {
            e.preventDefault();
            console.log("🔥 [DEBUG] 애플 버튼이 클릭되었습니다.");
            $errorDiv.hide();
            ...
            try {
                ...
                alert("애플 로그인 팝업 호출 중 오류: " + err.message);
                showError("애플 로그인 호출 오류: " + err.message);
                enableButtons();
            }
        });
    });
