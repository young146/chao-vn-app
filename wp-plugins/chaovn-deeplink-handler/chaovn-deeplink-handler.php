...
function chaovn_render_share_page($type, $id)
{
        ...
        <style>
            * {
            ...
            body {
                ...
                background: linear-gradient(135deg, <?php echo $info['color']; ?>15 0%, <?php echo $info['color']; ?>05 100%);
                min-height: 100vh;
                display: flex;
                align-items: center;
    ...
    <body>
        <div class="container">
            ...
            <a href="https://chaovietnam.co.kr" class="btn" style="background:#f5f5f5; color:#666; margin-top:20px;">웹사이트로
                이동</a>
        ...
        <script>
            ...
            function openApp() {
                if (isAndroid) {
                    // Android: intent:// 스킴으로 URL 데이터 확실히 전달
                    var intentUrl = appScheme.replace('chaovietnam://', 'intent://');
