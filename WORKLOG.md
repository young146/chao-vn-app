...
- **상위 검색어가 전부 쓰레기**: 구더기 · 탑승 · 고양이 · 유튜브(노출 23,381·클릭 2) ·
  키이우 · 오사카 지진. 매일 자동 발행하는 세계뉴스가 **엉뚱한 한 단어로 색인**돼
  노출만 쌓고 클릭이 안 난다. **CTR 1.25% 의 정체가 이것.**
- **여행 검색어**: 노출 10,017(3.8%) · 클릭 38 · 평균 7.0위 — 들어오긴 하는데 못 잡고 있다.
- ⭐ **환율**: 검색어 94개 · 노출 6,393 · **평균 4위** · 클릭 **17**(CTR 0.1~0.7%).
  → 이미 4위로 뜨는데 안 눌린다. **환율 찾는 사람에게 뉴스 기사를 보여주니 찾던 숫자가 없어서다.**
...
3. **(별건, A/B 무관)** 쓰레기 색인 정리 — '구더기·고양이·유튜브' 로 잡히는 세계뉴스가
   사이트 전체 CTR 을 1.25% 로 끌어내리고 있다. 구글은 사이트 단위 신호도 본다
