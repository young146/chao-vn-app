...
## 2026-08-28 — 📮 [구독] 모집 카드·기사 하단 입력칸 · **매일 23%가 버려지던 이유를 찾았다**
...
**사장님이 하실 것**
1. **플러그인 v2.7.0 FTP 업로드** — 이걸 올려야 기사 하단 입력칸이 산다
...
- **다음 단계** (사장님 지시 대기, 셋 다 독립적)
  1. **앱에 PDF 버튼 추가** — 웹과 같은 규칙(지난 호에만). OTA 1회.
