    ...
    >
      <View style={styles.modalContainer}>
        ...
        <ScrollView style={styles.modalBody} contentContainerStyle={{ paddingBottom: 40 }}>
          ...
          <View style={styles.modalSection}>
            ...
            {company.homepage ? (
              <TouchableOpacity style={styles.modalContactRow} onPress={handleHomepage}>
                ...
                <Text style={[styles.modalContactText, { color: '#2196F3' }]} numberOfLines={1}>{company.homepage}</Text>
                <Ionicons name="chevron-forward" size={16} color="#ccc" />
              </TouchableOpacity>
            ) : null}

            {company.email ? (
              <TouchableOpacity style={styles.modalContactRow} onPress={handleEmail}>
                <View style={[styles.contactIconWrap, { backgroundColor: '#FFF3E0' }]}>
                  <Ionicons name="mail" size={20} color="#FF9800" />
                </View>
                <Text style={[styles.modalContactText, { color: '#FF9800' }]} numberOfLines={1}>{company.email}</Text>
                <Ionicons name="chevron-forward" size={16} color="#ccc" />
              </TouchableOpacity>
            ) : null}
          </View>
          ...
          {/* 출처 */}
          {company.source ? (
            <TouchableOpacity style={styles.sourceRow} onPress={company.source_url ? handleSource : null}>
              <Text style={styles.sourceLabel}>출처: </Text>
              <Text style={[styles.sourceText, company.source_url && { color: '#2196F3', textDecorationLine: 'underline' }]}>
                {company.source}
              </Text>
            </TouchableOpacity>
          ) : null}
