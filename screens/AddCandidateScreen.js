...
const JOB_TRACKS_KO = ["사무직", "관리직", "현장직", "영업직", "기술직/IT", "생산직", "서비스직", "통번역", "교육직", "운전직", "기타"];
const JOB_TRACKS_VI = ["Văn phòng", "Quản lý", "Thực địa", "Kinh doanh", "Kỹ thuật/IT", "Sản xuất", "Dịch vụ", "Phiên dịch", "Giáo dục", "Lái xe", "Khác"];
const JOB_TRACKS_EN = ["Office", "Management", "Field", "Sales", "Technical/IT", "Production", "Service", "Translation", "Education", "Driving", "Other"];
const JOB_TRACK_KEY = ["사무직", "관리직", "현장직", "영업직", "기술직/IT", "생산직", "서비스직", "통번역", "교육직", "운전직", "기타"]; // 저장 고정값
